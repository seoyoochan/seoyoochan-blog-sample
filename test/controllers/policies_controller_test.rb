...
class PoliciesControllerTest < ActionController::TestCase
  ...
  test "should create policy" do
    assert_difference('Policy.count') do
      post :create, policy: { body: @policy.body, type: @policy.type, user_id: @policy.user_id, version: @policy.version }
    end
  ...
  test "should update policy" do
    patch :update, id: @policy, policy: { body: @policy.body, type: @policy.type, user_id: @policy.user_id, version: @policy.version }
    assert_redirected_to policy_path(assigns(:policy))
  end
